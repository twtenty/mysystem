...
public class EmLookListener implements ActionListener{

	final int WIDTH = 800;
	final int HEIGHT = 450;
	
	private static String cuid = new String();
...
//		jf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		...
		try {
			BackGroundPanel bgPanel = new BackGroundPanel(ImageIO.read(new File("images/14.jfif")));
			jf.add(bgPanel);
...
//				 System.out.println(cuid);
		...
		DeBtn.addActionListener(new EmLoCuorListener());
