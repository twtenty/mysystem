...
public class EmLoCuorListener implements ActionListener{
	...
	public void actionPerformed(ActionEvent e) {
		// TODO 自动生成的方法存根
		JFrame jf = new JFrame(EmLookListener.getCuid()+"的订单表");
		try {
			BackGroundPanel bgPanel = new BackGroundPanel(ImageIO.read(new File("images/13.jfif")));
			jf.add(bgPanel);
...
//		jf.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	    ...
	    String sql = "select * from orders where cuid = '"+EmLookListener.getCuid()+"'";
...
//					System.out.println(now.isFlag());
					...
					else
					{
						...
						if(flag==false)
						{
							Customer cu = Data.getCu().search(EmLookListener.getCuid());
							Customer cu1= cu;
							cu.setFlag(0);
							Data.getCu().edit(cu1, cu);
							
						}
						JOptionPane.showMessageDialog(new JFrame(),"送餐成功");
					}
